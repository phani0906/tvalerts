        ...
        try {
            ...
            for (const r of list) {
                ...
                if (openVal != null || priceVal != null) {
                    ...
                    if (priceVal != null) priceSpan.textContent = fmt2(priceVal);
                ...
                // ===== PDH (Previous Day High) — sits AFTER Mid-point =====
                const tdPDH = document.createElement('td');
                ...
                if (pl) {
                    ...
                    // highlight neighbors bracketing price
